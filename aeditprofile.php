...
<section class="sec-padding contact-page-content">
	<div class="thm-container">
		...
		<!--	<h3> <a href="farmersignup.php">	<b>Forgot Password ? Click Here</b> </a></h3>-->
		
		</div><br>
		<div class="row">
			<div class="col-md-7 col-sm-6 col-xs-12 pull-left">
				<form action="aeditprofilesave.php" method="post" class="contact-form contact-page">
					<p><input id="name" type="password" required placeholder="Old Password" name="a"></p>
					<p><input id="email" type="password" required placeholder="New Password" name="b"></p>
					<p><input type="password" placeholder="Confirm Password" required name="c"></p>
					
					<button class = "popup"  type="submit" class="thm-btn">Reset Password<span class="popuptext" id="myPopup">Thanks for your response</span></button>
