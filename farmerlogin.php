...
<section class="sec-padding contact-page-content">
	<div class="thm-container">
		<div class="sec-title">
			<h2><span>Farmer Login</span> </h2>
			<h3> <a href="farmersignup.php">	<b>No Account ? Click Here</b> </a></h3>
			<h3> <a href="fforgotpwd.php">	<b>Forgot Password ? Click Here</b> </a></h3>
		
		</div><br>
		<div class="row">
			<div class="col-md-7 col-sm-6 col-xs-12 pull-left">
				<form action="farmerloginsave.php" method="post" class="contact-form contact-page">
				...
				<h1 align="center> No Account ? Click Here </h1>
			</div>
