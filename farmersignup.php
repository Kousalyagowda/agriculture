...
<section class="sec-padding contact-page-content">
	<div class="thm-container">
		<div class="sec-title">
			<h2><span>Register Me</span></h2>
			<h3> <a href="farmerlogin.php">	<b>Has an Account ? Click Here</b></a> </h3>
		</div><br>
		<div class="row">
			<div class="col-md-7 col-sm-6 col-xs-12 pull-left">
				<form action="farmersignupsave.php" method="post" class="contact-form contact-page">
                <p><input id="name" type="text" pattern="[A-Za-z]+" title="letters only"  placeholder="Full Name" required name="a"></p>
					<p><input id="email" type="text" placeholder="Mobile"  pattern="^\d{10}$" title="only nos should be 10 digits"  required name="b"></p>
					<p><input id="name" type="text" placeholder="Email Id" requiredname="c"></p>
					<p><input id="email" type="password" placeholder="Password" required name="d"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"></p>
					<!--<p><input type="text" placeholder="Subject" name="subject"></p>-->
					
					<button class = "popup"  type="submit" class="thm-btn">Register Me<span class="popuptext" id="myPopup">Thanks for your response</span></button>
