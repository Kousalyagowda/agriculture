...
<section class="sec-padding contact-page-content">
	<div class="thm-container">
		<div class="sec-title">
			<h2><span>Add Seeds Details</span></h2>
		...
		<div class="row">
			<div class="col-md-7 col-sm-6 col-xs-12 pull-left">
                ...
                <p><input id="name" type="text" placeholder="Seed-Id" name="a"></p>
					<p><input id="email" type="text" placeholder="Seed-Name" name="b"></p>
					...
					<button class = "popup"  type="submit" name="submit" class="thm-btn">Add<span class="popuptext" id="myPopup">Thanks for your response</span></button>
...
$q=$_POST["q"]; */
	//echo $photo;
$sql="select * from  seeds where seedid='{$a}' ";
//echo $sql;
$found=0;
...
{	
	...
	if($found==1)
	{
		...
		echo("<script>alert(' Registered Already');window.location='seedsadd.php';</script>");
...
$query = "insert into seeds values('$a','$b','$c','$d')";
