...
<section class="sec-padding contact-page-content">
	<div class="thm-container">
		<div class="sec-title">
			<h2><span>Add Fertilizer Details</span></h2>
		...
		<div class="row">
			<div class="col-md-7 col-sm-6 col-xs-12 pull-left">
                ...
                <p><input id="name" type="text" placeholder="Fertilizer-Id" name="a"></p>
					<p><input id="email" type="text" placeholder="Fertilizer-Name" name="b"></p>
					<p><input id="name" type="text" placeholder="Rate" name="c"></p>
					<p><input id="email" type="text" placeholder="Updated-Date" name="d"></p>
...
$q=$_POST["q"]; */
	//echo $photo;
$sql="select * from  fertilizer where fid='{$a}'  ";
//echo $sql;
$found=0;
...
{	
	...
	if($found==1)
	{
		...
		echo("<script>alert(' Registered Already');window.location='afertiadd.php';</script>");
...
$query = "insert into fertilizer values('$a','$b','$c','$d')";
