...
<section class="sec-padding contact-page-content">
	<div class="thm-container">
		<div class="sec-title">
			<h2><span>Add Subsidy Details</span></h2>
		...
		<div class="row">
			<div class="col-md-7 col-sm-6 col-xs-12 pull-left">
                ...
                <p><input id="name" type="text" required placeholder="Subsidy-Id" name="a"></p>
					<p><input id="email" type="text" required placeholder="Subsidy-Name" name="b"></p>
					<p><input id="name" type="text"  required placeholder="Criteria" name="c"></p>
					<p><input id="email" type="text" required placeholder="Updated Date" name="d"></p>
					<!--<p><input type="text" placeholder="Subject" name="subject"></p>-->
					
					<button class = "popup"  name="submit" type="submit" class="thm-btn">Add<span class="popuptext" id="myPopup">Thanks for your response</span></button>
...
$q=$_POST["q"]; */
	//echo $photo;
$sql="select * from  subsidy where sid='{$a}'  ";
//echo $sql;
$found=0;
...
{	
	...
	if($found==1)
	{
		...
		echo("<script>alert(' Registered Already');window.location='subsidyadd.php';</script>");
...
$query = "insert into subsidy values('$a','$b','$c','$d')";
...
echo("<script>alert(' Registered Successfully');window.location='adminhomepage.php';</script>");
