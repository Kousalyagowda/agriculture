...
<header>
	<div class="header">
	 ...
	 <br>
      ...
      <a href="farmerhomepage.php">Home</a>
	  <a href="feditprofile.php">Profile</a>
	   <div class="subnav">
    
		   <button class="subnavbtn">Subsidy-Details<i class="#"></i></button>
		   <div class="subnav-content">
           <li>  </li>
		   <li><a href="fsearch.php">Search</a></li>
		   <li><a href="fapply.php">Apply</a></li>
		   </div>
	   </div>
	  <!-- <a href="govts.html">About</a>
	   ...
	   <div class="subnav">
		   ...
		   <div class="subnav-content">
		   <li><a href="fpost.php">Post</a></li>
		   <li><a href="freplies.php">Replies</a></li>
		   <li><a href="ffertilizer.php">Fertilizer</a></li>
		   <li><a href="fseeds.php">Seeds</a></li>
		   </div>
	   </div>
	  <!-- <div class="subnav">
...
<section class="sec-padding contact-page-content">
	<div class="thm-container">
		<div class="sec-title">
			<h2><span>Sudsidy Details</span></h2>
		...
		<div class="row">
			...
			<table id="customers" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="200">Subsidy-Id</th>
                                            <th width="120">Subsidy-Name</th>

                                             <th width="180">Criteria</th>   
											 <th width="180">Last Date</th>   
											 <th>ACTION</th>          
			...
			include('config.php');
			$sql = "SELECT * from seeds order by updatedate desc ";
...
$sql="select * from subsidy ";// where emailid='{$uname}'"; 
...
$d=$row[3];
      ...
      ?>  
                                         ...
                                         <tr>
                                            ...
                                            <td><?php echo $c;?></td>
                                            <td><?php echo $d ; ?></td>
											<td><a href=fapply1.php?id=<?php echo $a; ?>&sn=<?php echo $b; ?>>APPLY</a></td>
