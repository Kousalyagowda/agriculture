...
<section class="sec-padding contact-page-content">
	<div class="thm-container">
		<div class="sec-title">
			<h2><span>Edit Seeds Details</span></h2>
...
$d=$row[3];
      ...
      ?>  
                                         ...
                                         <tr>
                                            ...
                                            <td><?php echo $c;?></td>
                                            <td><?php echo $d ; ?></td>
											<td><a href=approveleave.php?lid=<?php echo $a; ?>  > <img src="edit.png" width=50 height=50></img></a></td>
											<td><a href=approveleave.php?lid=<?php echo $a; ?> ><img src="delete.png" width=50 height=50></img></a></td>
