	...
	<div class="thm-container">
		...
		<div class="row">
			<div class="col-md-7 col-sm-6 col-xs-12 pull-left">
                ...
                <p>SERIAL NO<input id="name" type="text" value="<?php  $s=$_GET["lid"]; echo $s;?>" readonly name="a"></p>
                ANSWER
					<p><input id="email" type="text" required placeholder="TYPE ANSWER" name="b"></p>
					
					<!--<p><input type="text" placeholder="Subject" name="subject"></p>-->
					
					<button class = "popup" name="submit" type="submit" class="thm-btn">REPLY<span class="popuptext" id="myPopup">Thanks for your response</span></button>
...
$query = "UPDATE QUERY SET STATUS='REPLIED',ANS='{$b}' where slno='{$a}'";
...
echo("<script>alert(' Updated Successfully');window.location='adminhomepage.php';</script>");
