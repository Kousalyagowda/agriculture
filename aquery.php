	...
	<div class="thm-container">
		...
		<div class="row">
			<div class="col-md-7 col-sm-6 col-xs-12 pull-left">
                ...
                <p><input id="name" type="text" placeholder="Full Name" name="a"></p>
					<p><input id="email" type="text" placeholder="Mobile" name="b"></p>
					<p><input id="name" type="text" placeholder="Email Id" name="c"></p>
					<p><input id="email" type="password" placeholder="Password" name="d"></p>
