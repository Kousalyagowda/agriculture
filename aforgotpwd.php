...
<section class="sec-padding contact-page-content">
	<div class="thm-container">
		<div class="sec-title">
			...
			<h3> <a href="adminlogin.php">	<b>Remember Password ? Click Here</b> </a></h3>
...
$query="update admin set password='#123$'  where email='{$email}'";
...
//echo("<H3 ALIGN=CENTER>Your New Password is ".'#123$'.'<h3>');
	echo( "<script>alert('New Password Generated');window.location='adminlogin.php';</script>");
	}		
else
{
		echo( "<script>alert('Some thing went Wrong Please Check');window.location='aforgotpwd.php';</script>");
}
