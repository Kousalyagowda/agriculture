...
<section class="sec-padding contact-page-content">
	<div class="thm-container">
		<div class="sec-title">
			...
			<h3> <a href="farmerlogin.php">	<b>Remember Password ? Click Here</b> </a></h3>
		
		</div><br>
		<div class="row">
			<div class="col-md-7 col-sm-6 col-xs-12 pull-left">
				<form action="" method="post" class="contact-form contact-page">
					<p><input id="name" type="text" required placeholder="Email Id" name="a"></p>
				
					<!--<p><input type="text" placeholder="Subject" name="subject"></p>-->
					
					<button class = "popup"  name="submit" type="submit" class="thm-btn">Forgot Password<span class="popuptext" id="myPopup">Thanks for your response</span></button>
...
$query="update farmer set password='#123$'  where email='{$email}'";

//echo $query;

mysqli_query($con,$query);

//echo("<H3 ALIGN=CENTER>Your New Password is ".'#123$'.'<h3>');
	echo( "<script>alert('New Password Generated');window.location='farmerlogin.php';</script>");
	}		
else
{
		echo( "<script>alert('Some thing went Wrong Please Check');window.location='fforgotpwd.php';</script>");
}
