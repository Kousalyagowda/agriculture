...
<section class="sec-padding contact-page-content">
	<div class="thm-container">
		<div class="sec-title">
			<h2><span>Search Details</span></h2>
		...
		<div class="row">
			<div class="col-md-7 col-sm-6 col-xs-12 pull-left">
               ...
               <h2> <p>Search By <select name="select" id="select">
                  <option value="Fertilizer">Fertilizer</option>
                  <option value="Seeds">Seeds</option>
                  <option value="Subsidy">Subsidy</option>
                </select>
				<button class = "popup" name="submit" type="submit" class="thm-btn">Search<span class="popuptext" id="myPopup">Thanks for your response</span></button>
			...
			if(isset($_POST["submit"]))
			{
				...
				if($s=="Fertilizer")
				{
						echo( "<script>alert(' Fertilzer Details Selectd');window.location='asearchfer.php';</script>");
				}
				if($s=="Seeds")
				{
						echo( "<script>alert(' Seeds Details Selected');window.location='asearchse.php';</script>");
				}
				if($s=="Subsidy")
				{
					echo( "<script>alert(' Subsidy Details Selected');window.location='asearchsu.php';</script>");
				}
			}
