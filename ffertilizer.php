...
<section class="sec-padding contact-page-content">
	<div class="thm-container">
		<div class="sec-title">
			<h2><span>Fertilizer Details</span></h2>
			...
			<table id="customers" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="200">Fertilizer-Id</th>
                                            <th width="120">Fertilizer-Name</th>

                                             <th width="180">Rate</th>   
											 <th width="180">Updated Date</th>   
...
$sql="select * from fertilizer ";// where emailid='{$uname}'"; 
